...
void PI_update(void) {
	...
	error = (2 * target_rpm) - motor_speed; // encoder units
  ...
  int16_t output = Kp * error; // Proportional Calculation
	output = output + error_integral; // Proportional + Integral Calculation
